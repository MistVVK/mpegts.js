    ...
    static dOps(meta) {
        ...
        switch (channelConfigCode) {
            ...
            case 0x06:
                ...
                break;
            case 0x07:
                mapping = [0x01, 4, 3, 0, 4, 1, 2, 3, 5, 6];
                break;
            case 0x08:
                mapping = [0x01, 5, 3, 0, 6, 1, 2, 3, 4, 5, 7];
                break;
            case 0x82:
                mapping = [0x01, 2, 0, 0, 1];
                break;
            case 0x83:
                mapping = [0x01, 3, 0, 0, 1, 2];
                break;
            case 0x84:
                mapping = [0x01, 4, 0, 0, 1, 2, 3];
                break;
            case 0x85:
                mapping = [0x01, 5, 0, 0, 1, 2, 3, 4];
                break;
            case 0x86:
                mapping = [0x01, 6, 0, 0, 1, 2, 3, 4, 5];
                break;
            case 0x87:
                mapping = [0x01, 7, 0, 0, 1, 2, 3, 4, 5, 6];
                break;
            case 0x88:
                mapping = [0x01, 8, 0, 0, 1, 2, 3, 4, 5, 6, 7];
                break;
        }
